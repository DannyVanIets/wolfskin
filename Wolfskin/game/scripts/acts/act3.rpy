...
# SCENE 35-39
    ...
    ed "I retired to the bedroom after Uldin's tale. I couldn't take much more of it. Afterwards, I fell into a deep and dreamless sleep."

    ed "I first noticed the wolfskin was gone when I heard the scream. I smelled the faint scent of Salome's perfume."
    ...
    il "Fleur still hasn't been found. People fear she's actually been spirited away."
    ...
    ed "Then you think she may be an accomplice… Or, if she were the murderer…"

    ed "She could do it, if she wore the wolfskin."

    ed "But without the wolfskin on her, she'd be suffering the same effects that I did. It's excruciating to go through."

    ed "When I first tried to get rid of the wolfskin, after I had been cursed with it, I was left howling in pain."
    ...
    il "Then maybe… an accomplice, even unwillingly? I strongly believe that she helped Salome."
    ...
    ed "It'll be difficult… but I can try. The walls are high, but I could scale them if I transform. I need you to survey the town layout and find something we could use."

    il "Understood. I should go — someone might be searching for me."

# SCENE 40

    "Ilona ties the chains around Edwin again. His possession of the wolfskin should remain a secret until the time comes to escape."
    ...
    "Ilona and Kellac investigate the town, as part of the search party for Fleur. While doing so, Ilona searches for an escape route, and anything else they could use to their advantage."
...
# SCENE 40
    ...
    "Anari is waiting, and several of the townsfolk look to the pyre stacked in the middle of the town square. There is an air of formality surrounding her, clad in her red hunting garments. They seem even more vibrant, illuminated by the glow of the dying sun."
    ...
    an "I'll start first with some important information. We could not locate Fleur, but we found this in the forest."
    ...
    an "Fleur is… lost to this world. During the search, we could not find even her footprints, or any clues towards her disappearance."

    an "…{p}With that matter settled, let's proceed with Edwin. The nun Ilona has prepared a defence. Please, rise."

# SCENE 41

    "The words were stuck in Ilona's throat. She thinks deeply about the contents of Fleur's letter."

    "{i}I could only choose one or the other, and so I have decided to take a test of faith to prove my worthiness.{/i}"

    il "This murder had two conspirators involved: Salome and Fleur."

    an "Hoh? Go on."

    il "Both Salome and Fleur conspired together to drug the guests at the banquet."

    il "The two of them figured out Edwin's true nature, and so one of them went to steal an item that would allow one to shift into a werewolf."

    an "And so? Who was the one that murdered Uldin?"
    ...
    il "The one who murdered Uldin was Fleur."

    an "Excuse me? I might have believed you if you said it was Salome."

    il "The corpse of Salome has been misidentified."

    an "What? Do you mistrust Kellac's judgement?"
    ...
    il "Her letter read: I will strike terror into the one who has abandoned me."

    il "Uldin is not frequently in this town, is he not? He has essentially abandoned his daughter."

    il "Only the guests were targeted to be drugged that night — but not Uldin, nor herself or her mother. She needed him awake to scare him."
    ...
    il "She wore her mother's dress, ring and perfume, perhaps to avoid suspicion if found wandering at night."

    an "I refuse to believe this…"

    il "You may believe in the fair folk, but this would explain why you were unable to find her; or even to glimpse any trace of her - she was already dead."

    an "Then how do you explain Fleur's letter? The wooden effigy of her that appeared in her bed?"

    il "Remember… There was an accomplice."

    il "Salome must have entered the room after the howl, and she let out a scream at the sight of both Uldin and Fleur's wounds. She took what was stolen from Edwin, and hid in the room before we entered."

    il "After we left the manse to escort Edwin to the dungeon, Salome was able to move again. She locked the wolfskin away in a chest in her room, and trapped it."

    il "Salome placed the statue in Fleur's bed to make it seem like she was spirited away by the fair folk."

    il "She must have found the letter in Fleur's room, and to make it seem more credible, she placed it in the forest after her escape."

    il "The one that orchestrated the plan was Salome, and she is the survivor. If you don't believe me, I found this."

    "Ilona hands Anari the paper she found in the chest. Upon realizing that it explains the wooden statue of Fleur, she looks thoroughly displeased, nearly crumpling the document."
...
# SCENE 42
    ...
    il "I do not care what happens next, Anari. Whether you believe me or not is irrelevant."
    ...
    an "Well, maybe I can tell you some other time. If we even get a chance that is.{p}In your mind, you may be right..."

    an "But unless you bring me Salome, you can't convince me. The ‘righteousness’ that you preach of is obsolete without tangible proof."

    an "Perhaps I’m misguided, but I’ve had far, far too many repercussions for trusting people in the past. In more ways than you can ever imagine."
    ...
    il "You're blaming us for being caught in a plot that was using us? For all I know, you were always looking for a reason to kill Edwin.{p}Maybe you planned for this to happen, to usurp power in Belorov."

    an "Hahahahaha! How amusing. I don't desire that in the least."

    an "You should choose your words more wisely, nun. It's unbecoming of a holy woman… but I know that you're really a heretic."

    "With a signal of Anari's hand, two town guards move in on Ilona and grip her arms tightly; drawing them behind her back. She screams loudly."
    ...
    "Anari strings her bow, and takes an arrow from her quiver. She trains it on the werewolf. He's escaping the town square with Ilona still in his arms."
...
# SCENE 44
    ...
    il "In all seriousness, thank you. It- it means a lot to me.{p}Could we rest for a while?"

    ed "I don't hear anyone pursuing us. Just for a moment…"

    "They sit under the shade of a tree, basking in its shadow. Their breath is ragged, but in sync with each other's. Ilona rests her head on Edwin’s shoulders."
    ...
    il "Besides, I’m here for you now.{p}And you are for me.{p}I’m sure that God will not send another trial to test our resolve."

    ed "I would like to believe that.{p}…"
    ...
    il "I guess it's hard sometimes. Especially when you have no one you can trust,{p}Nobody to confide in."

    il "And you’re all alone, because you always second guess intentions…{p}…{p}There’s nothing worse than feeling utterly alone."
    ...
    il "Is it okay if I close my eyes for a while?{p}I don’t think I’ll be able to hold out for any longer…"
    ...
    ed "I-I just…{p}I just wanted to say that I’m indebted."

    il "You're always thanking me…{p}Ed…"
